...
const Home = ({ navigation }) => {
  ...
  const initialCurrentLocation = {
    streetName: "DL Colony, VSS Nagar",
    gps: {
      latitude: 20.313477270379938,
      longitude: 85.84451263582606,
    },
  };
  const categoryData = [
    {
  ...
  function renderHeader() {
    return (
      <View style={{ flexDirection: "row", height: 40, marginTop: 40 }}>
        <TouchableOpacity
          style={{
            width: 50,
